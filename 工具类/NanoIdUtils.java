...
/**
 * @Description： nanaoId生成id
 * @Author: cangsu
 * @Date: 2022-7-21 17:44
 **/
public class NanoIdUtils {
    private static final SecureRandom DEFAULT_NUMBER_GENERATOR = new SecureRandom();
    private static final char[] DEFALUT_ALPHABET = "_-0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".toCharArray();
    ...
    public static String randomNanoId() {
        return randomNanoId(DEFAULT_NUMBER_GENERATOR, DEFALUT_ALPHABET, DEFAULT_SIZE);
    }

    private static String randomNanoId(Random random, char[] alphabet, int size) {
        if (random == null) {
